...
export class ClientApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getEnterprise(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public getFolder(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/:id/folder";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createFolder(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateFolder(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/:id/folder";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyFolder(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/:id/folder";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyFolder(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/:id/folder";
    let _routeParams: any = {
